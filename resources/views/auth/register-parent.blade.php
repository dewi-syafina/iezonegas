...
<head>
    ...
    <title>Registrasi Orang Tua - IEZ-ONE</title>
...
<body>
    <div class="register-card" data-aos="zoom-in">
        ...
        <div class="text-center mb-6">
            <h1 class="text-3xl mb-2">Registrasi Orang Tua</h1>
            <p class="text-gray-500 text-sm">Daftarkan akun Orang Tua Anda di IEZ-ONE</p>
        </div>
        ...
        <form method="POST" action="{{ route('parent.register.store') }}">
            ...
            <label for="nis_siswa" class="block text-gray-700 font-semibold mb-1">NIS Anak</label>
            <input id="nis_siswa" name="nis_siswa" type="text" placeholder="Masukkan NIS Anak" value="{{ old('nis_siswa') }}" required>
